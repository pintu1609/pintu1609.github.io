    ...
    <div>
      ...
      <div className="project d-flex justify-content-between" >
        ...
        <h2 className='conatct' style={{color:'#001c55', paddingTop:50, paddingBottom:20 , fontSize:60 }}>
            ...
            <p  style={{paddding:'0 30px', fontSize:20 , textAlign:'center'}}>My projects makes use of vast variety of latest technology tools. My best experience is to create Artificial Inteligence projects and deploy them to web applications using cloud infrastructure.</p>
        </div>
      </div>
        </div>
    </div>
